...
### Interpretation 
  ...
  - **Scaled Height**: Height positively impacts the likelihood of success, per unit increase in height the chancees of success increase by 1.3 units.
...
**NOTE:** To build this model, I removed a significant amount of null data. This removal process might have introduced some bias into the dataset, potentially affecting the model's overall accuracy and interpretations. This could explain the negative coefficient for gender, suggesting that being male is associated with a lower likelihood of success. Despite the overall dataset showing a 50/50 split in medallists between genders, the reduced dataset might not fully represent this balance.
...
###  Most Popular Hobbies Amongst Medallists 

<div style="text-align: center;">
  <img src="{{ site.baseurl }}/assets/images/hobbies_top.png" alt="Top hobbies" style="max-width: 100%; height: auto; margin: 20px 0;">
</div>
...
-	Watching content, sport or not, can be a form of relaxation. This can help athletes in unwinding and relaxing, both are important mentally before competing. 
...
- **Social Activities:** Meeting friends is also a notable hobby, suggesting that despite their demanding schedules, medallists prioritise time with peers/family.
  
**5.	Video Games:**

- **Playing Video Games:** Video games may serve as a mental break or a way to engage in a competitive environment outside of their professional sports.
...
These phrases capture the core philosophies that drive athletes to achieve success.
...
In my analysis, I faced a considerable amount of null data, which is common when collecting detailed personal information such as hobbies and rituals. Given that this data capture can be time-consuming, the prevalence of missing values was expected. I decided to remove all rows with missing data, despite the significant reduction in dataset size as to me it was essential to ensure models were based on complete information.

In the future, if I was to collect data about athletes, I would encourage them to provide more detailed information by:

**1.	Incentives:** Offering rewards such as access to exclusive training resources or even financial incentives could motivate athletes to share more data.
...
**3.	Highlighting Benefits:** Explain how detailed data can improve the accuracy of performance analysis and insights, leading to better understanding and support based on patterns and trends identified in the data.

Throughout this post I have explored various aspects of Olympic success. I investigate the distribution of medals across countries, the representation of genders among athletes, and the achievements of top performers. Additionally, I examine the relationship between age and performance and identify key factors that contribute to success through logistic regression. Finally, using NLP analysis, I uncover common hobbies may play a role in the success of medallists. 
