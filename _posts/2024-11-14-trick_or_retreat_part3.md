...
<div style="text-align: center;">
  <img src="{{ site.baseurl }}/assets/trick-or-retreat/Simple_env_layout.png" alt="Simple Env Img" style="max-width: 100%; height: auto; margin: 20px 0;">
</div>
...
<div style="text-align: center;">
    <video width="640" height="480" controls>
        <source src="{{ site.baseurl }}/assets/trick-or-retreat/simple_env.mp4" type="video/mp4">
